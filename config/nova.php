...
//    'login_view' => null, // Set this to your custom login view if needed
    ...
    */
    ...
    'brand' => [
         //'logo' => resource_path('img/logo/achilles_international_logo.svg'),
         'logo' => public_path('img/logos/achilles_international_logo.svg'),
        ...
        'login' => [
            'show_logo' => true,
            'show_social_auth' => true, // Add this line
        ],
        'login_template' => resource_path('views/vendor/nova/auth/login.blade.php'),
    ],
